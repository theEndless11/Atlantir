...
const kt = /* @__PURE__ */ Le({
  ...
  setup(e, { expose: n, emit: i }) {
    ...
    return n({
      ...
      Dt(Yt, { onNotify: K(z) }, null, 8, ["onNotify"])
    ], 34)), [
      [K(d), K(L)]
    ]);
  }
...
function An({
  ...
  const n = Ft({}), i = ae(null);
  let t = null;
  const l = un();
  if (!l)
    throw new Error("[useIdState] Must be called inside setup()");
  const d = typeof e == "function" ? () => e(l.proxy) : () => l.proxy[e];
  function h(v) {
    const C = l.proxy.$options.idState;
    if (typeof C == "function") {
      const T = C.call(l.proxy, l.proxy);
      return n[v] = T, t = v, T;
    } else
  ...
  function S() {
    const v = d();
    v == null && console.warn(`No id found for IdState with idProp: '${e}'.`), v !== t && (n[v] || h(v), i.value = n[v]);
  }
  return q(d, (v) => {
    He(() => {
      t = v;
...
function Cn(e, n) {
  e.component(`${n}recycle-scroller`, at), e.component(`${n}RecycleScroller`, at), e.component(`${n}dynamic-scroller`, Mt), e.component(`${n}DynamicScroller`, Mt), e.component(`${n}dynamic-scroller-item`, xt), e.component(`${n}DynamicScrollerItem`, xt), e.component(`${n}window-scroller`, kt), e.component(`${n}WindowScroller`, kt);
}
const En = {
  version: "2.0.0",
  install(e, n) {
    ...
    for (const t in i)
      typeof i[t] < "u" && (Pt[t] = i[t]);
    i.installComponents && Cn(e, i.componentsPrefix);
  }
};
export {
  Mt as DynamicScroller,
  xt as DynamicScrollerItem,
  at as RecycleScroller,
  kt as WindowScroller,
  En as default,
  Tn as useDynamicScroller,
  xn as useDynamicScrollerItem,
  An as useIdState,
  mt as useRecycleScroller,
  kn as useWindowScroller
};
